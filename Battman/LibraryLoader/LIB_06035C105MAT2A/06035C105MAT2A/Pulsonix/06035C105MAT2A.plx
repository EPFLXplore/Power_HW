...
//17998636/986527/2.50/2/5/Capacitor
...
(library Library_1
	...
	(symbolDef "06035C105MAT2A" (originalName "06035C105MAT2A")
	...
	(compDef "06035C105MAT2A" (originalName "06035C105MAT2A") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "06035C105MAT2A"))
		...
		(attr "Mouser Part Number" "581-06035C105MAT2A")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KYOCERA-AVX/06035C105MAT2A?qs=%252BdQmOuGyFcHMsevPtc6OZQ%3D%3D")
		(attr "Manufacturer_Name" "Kyocera AVX")
		(attr "Manufacturer_Part_Number" "06035C105MAT2A")
		(attr "Description" "Multilayer Ceramic Capacitors MLCC - SMD/SMT R102 HIGH CV")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/06031A100FAT2A.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "06035C105MAT2A.stp")
