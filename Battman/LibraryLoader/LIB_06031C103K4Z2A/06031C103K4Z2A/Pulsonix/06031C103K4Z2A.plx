...
//236934/986527/2.50/2/5/Capacitor
...
(library Library_1
	...
	(symbolDef "06031C103K4Z2A" (originalName "06031C103K4Z2A")
	...
	(compDef "06031C103K4Z2A" (originalName "06031C103K4Z2A") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "06031C103K4Z2A"))
		...
		(attr "Mouser Part Number" "581-06031C103K4Z2A")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=581-06031C103K4Z2A")
		(attr "Manufacturer_Name" "Kyocera AVX")
		(attr "Manufacturer_Part_Number" "06031C103K4Z2A")
		(attr "Description" "Capacitor MLCC 0603 10nF 100V AVX 0603 Standard 10nF Ceramic Multilayer Capacitor, 100 V dc, +125C, X7R Dielectric, +/-10% SMD")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/06031C103K4Z2A.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "06031C103K4Z2A.stp")
