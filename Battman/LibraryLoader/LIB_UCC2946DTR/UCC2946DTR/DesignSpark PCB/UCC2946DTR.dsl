SamacSys ECAD Model
1053015/986527/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "UCC2946DTR" (originalName "UCC2946DTR")
	...
	(compDef "UCC2946DTR" (originalName "UCC2946DTR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "RTH") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "__RES") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "RP") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VDD") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "WDI") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "WP") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "__WDO") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "UCC2946DTR"))
		...
		(attr "Mouser Part Number" "595-UCC2946DTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/UCC2946DTR?qs=eJkN62t4xTUCNkQ98mH6MA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "UCC2946DTR")
		(attr "Description" "Microprocessor Supervisor with Watchdog Timer")
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/UCC2946")
		(attr "Height" "1.75 mm")
	)
